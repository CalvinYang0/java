...
public class Test extends TestCase {
	...
	private void initSystem() {
		/* 添加学生信息 */
		Student student =new Student("stu_001", "小明", "13139149931", "22352@qq.com", "2021223111", false, "本科二年级", "软件学院");

		usSystem.addStudent(
				new Student("stu_001", "小明", "13139149931", "22352@qq.com", "2021223111", false, "本科二年级", "软件学院"));
		usSystem.addStudent(
				new Student("stu_002", "小红", "13139149932", "22152@qq.com", "2021223112", true, "本科二年级", "软件学院"));
		usSystem.addTeacher(new Teacher("tea_001", "肖老师", "15304114352", "xiao@nwpu.edu.cn", "01342", "软件学院"));
		usSystem.addOrganizer(new Organizer("org_001", "软件学院官方", "010" + "-03901234", "software@nwpu.edu.cn", "软件学院"));
	...
	public void test03() {
		try {
			...
			// 学生的增删改查
			usSystem.addStudent(
					new Student("stu_003", "小红", "43139149932", "122152@qq.com", "2021223134", true, "本科二年级", "软件学院"));
			Student stu2 = usSystem.getStudentById("stu_003");
			stu2.setEmail("235462@qq.com");
			usSystem.removeStudentById("stu_003");
			// 教师的增删改查
			usSystem.addTeacher(new Teacher("tea_002", "马老师", "15334114352", "ma@nwpu.edu.cn", "01242", "软件学院"));
			...
			usSystem.addOrganizer(
					new Organizer("org_002", "计算机学院官方", "010" + "-03904534", "compute@nwpu.edu.cn", "计算机学院"));
	...
	public void test07() {
		try {
			...
			// 将 tea1 添加到 act1
			Teacher tea = new Teacher("tea_003", "吕老师", "153666888", "lv@nwpu" + ".edu.cn", "01145", "软件学院");
			asSystem.getActivityById("act_001").addTeacherToActivity(tea);
			asSystem.getActivityById("act_001").removeTeacherFromActivity("tea_003");
	...
	public void test08() {
		try {
			...
			Organizer org = new Organizer("org_003", "软件学院官方", "010-03901234", "software@nwpu.edu.cn", "软件学院");
			asSystem.getActivityById("act_001").addOrganizerToActivity(org);
			asSystem.getActivityById("act_001").removeOrganizerFromActivity("org_003");
